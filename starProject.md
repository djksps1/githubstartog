...
- **Description:** ChatGPT官网接口纯协议的逆向实现，支持GPT-Image-2模型、文本模型，兼容OpenAI接口协议，在线批量生图/编辑图，号池管理，支持可编辑PPT/PSD文件逆向，支持导入CPA、sub2api号池 、支持接入Cherry  Studio、New Api 等软件
...
- **Description:** 一款轻量级、高度可定制的 Windows桌面和任务栏硬件性能监控工具，支持监测 CPU、GPU、内存、磁盘、网速、FPS 计数、插件扩展及内存清理。A lightweight, customizable hardware monitor for the Windows desktop & taskbar. Features CPU/GPU/RAM/Network monitoring, FPS counter, plugin support, and memory optimization.
...
- **Description:** Save Any Telegram File to Anywhere 📂 (Alist, Disk, Webdav, S3, Rclone...) . Support restrict saving content and files beyond telegram.
...
- **Description:** Documented system prompts from Anthropic - Claude Fable 5.1, Opus 5.5, Claude Design, Claude Code. OpenAI - ChatGPT GPT-6-Astra, Codex. Google - Gemini 3.8 Flash, 3.1 Pro, Antigravity. xAI - Grok, Grok Bot, Cursor, Kimi and more! Updated regularly.
...
- **Description:** FastAPI + Playwright + Camoufox 中间层代理服务器，兼容OpenAI API且支持参数转发。项目通过浏览器自动化将API请求转发到 Google AI Studio Chat，并同样按照OpenAI标准格式返回的工具。内置调试WebUI面板。
...
- **Description:** One Worker, All Subscriptions
...
### [linksocks/linksocks](https://github.com/linksocks/linksocks)
...
### [dynos01/DomainScanningTool](https://github.com/dynos01/DomainScanningTool)
...
### [Anil-matcha/AI-Youtube-Shorts-Generator](https://github.com/Anil-matcha/AI-Youtube-Shorts-Generator)
...
- **Description:** Python微信机器人框架，支持微信3.6.0.18、3.9.2.23、3.9.5.81、3.9.10.19、3.9.10.27、3.9.11.17、3.9.12.15、3.9.12.45、3.9.12.51、4.0.1.21、4.0.3.22、4.1.0.34、4.1.2.17、4.1.5.16、4.1.6.14、4.1.6.46、4.1.7.30，4.1.8.27、4.1.8.67、4.1.11.24、4.1.12.26、4.1.12.55、4.1.13.12、4.1.13.56版本（微信最新版本），企业微信4.1.0.6011、4.1.22.6014、4.1.33.6009、5.0.0.6008、5.0.3.6005版本。
...
### [bg8ixz/Serv00_Auto_Login](https://github.com/bg8ixz/Serv00_Auto_Login)
...
### [liuzijian-cs/AcademicCodeAnnotator](https://github.com/liuzijian-cs/AcademicCodeAnnotator)
- **Description:** Academic Code Annotator 基于LLAMA3的学术代码解读器。上传pdf格式的论文和python文件，根据论文的内容自动注释代码并导出。欢迎大家继续优化~

### [the1812/Bilibili-Evolved](https://github.com/the1812/Bilibili-Evolved)
- **Description:** 强大的哔哩哔哩增强脚本

### [ityard/python-fxxk-spider](https://github.com/ityard/python-fxxk-spider)
- **Description:** 收集各种免费的 Python 爬虫项目

### [ltxhhz/LL-plugin-list-viewer](https://github.com/ltxhhz/LL-plugin-list-viewer)
- **Description:** LiteLoaderQQNT Plugin 插件列表 查看·安装·更新
...
- **Description:** QNotified phoenix - To make OICQ great again
...
### [igrigorik/videospeed](https://github.com/igrigorik/videospeed)
- **Description:** HTML5 video speed controller (for Google Chrome)

### [ddy-ddy/cs-408](https://github.com/ddy-ddy/cs-408)
- **Description:** 计算机考研专业课程408相关的复习经验，资源和OneNote笔记

### [codehub666/94list](https://github.com/codehub666/94list)
...
- **Description:** MagicEdit: High-Fidelity Temporally Coherent Video Editing
